...
//
// Step 4 (research-notes/18). Reads the binary record stream produced by `cam_kernel ... -`, runs
// OpenVINS on it, and injects each resulting pose through TrackingDataInjection
// (research-notes/23). No Meta
...
// ── injection (same interface as pose_inject.c in this dir) ─────────────────────────────────
