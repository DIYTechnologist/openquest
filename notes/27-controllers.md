...
Other sub-record tags seen but not decoded: `0x2480`, `0x8780`, `0x2680`, `0x0528`. `0xd9` (1 Hz,
33 B) embeds the same device id and looks like a periodic status/announce.
